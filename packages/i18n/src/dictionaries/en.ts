...
export const en: Dictionary = {
  ...
  dispatch: {
    ...
    queueEmpty: "No orders in the queue right now.",
    columnCustomer: "Customer",
    columnStatus: "Status",
    columnItems: "Items",
    markInPrepButton: "Start prep",
    markReadyButton: "Mark ready for pickup",
    assignDeliveryLabel: "Delivery",
    assignDeliveryPlaceholder: "Select a delivery person",
    assignDeliveryButton: "Assign",
    deliveryTitle: "My deliveries",
    deliveryEmpty: "No orders assigned to you right now.",
