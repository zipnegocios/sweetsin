...
export const es: Dictionary = {
  ...
  dispatch: {
    queueTitle: "Cola de despacho",
    queueEmpty: "No hay órdenes en la cola por ahora.",
    columnCustomer: "Cliente",
    columnStatus: "Estado",
    columnItems: "Items",
    markInPrepButton: "Iniciar preparación",
    markReadyButton: "Marcar lista para retiro",
    assignDeliveryLabel: "Delivery",
    assignDeliveryPlaceholder: "Elegir un repartidor",
    assignDeliveryButton: "Asignar",
    deliveryTitle: "Mis entregas",
    deliveryEmpty: "No tenés órdenes asignadas por ahora.",
    markDeliveredButton: "Marcar entregada",
  },
  account: {
