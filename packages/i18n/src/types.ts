...
export interface Dictionary {
  ...
  admin: {
    ...
    navStaff: string;
    staffTitle: string;
    staffColumnName: string;
    staffColumnEmail: string;
    staffColumnRole: string;
    staffColumnStatus: string;
    staffColumnActions: string;
    staffResetPinButton: string;
    staffDeactivateButton: string;
    staffActivateButton: string;
    staffPinRevealPrefix: string;
    staffEmpty: string;
    staffFormName: string;
    staffFormEmail: string;
    staffFormRole: string;
    staffFormPassword: string;
    staffFormRoleDespachador: string;
